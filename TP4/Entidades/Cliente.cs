...
namespace Entidades
{
    ...
    public class Cliente
    {
        ...
        public Cliente(string nombre, string apellido, EGenero genero, int dni, int telefono, string planAdquirido,bool estaActivo)
        {
            this.nombre = nombre;
        ...
        public string PlanAdquirido { get { return planAdquirido; } set { planAdquirido = value; } }
        ...
        public override string ToString()
        {
            ...
            sb.AppendLine($"Plan Adquirido: {planAdquirido}");
            return sb.ToString();
        }
        /// <summary>
        ...
        {
            List <Cliente> clientes =  ClienteAccesoDatos.LeerClientes();
            bool exists = clientes.Exists(item =>item.Dni == dni);
            return exists;           
        }
        ...
        public static Cliente CrearCliente(string nombre, string apellido, EGenero genero, int dni, int telefono, string membresia,bool estaACtivo)
        {
